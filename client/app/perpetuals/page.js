...
function TradingPage() {
  ...
  // Mobile tab state - Updated to include trades as trading panel
  ...
  return (
    <div className='min-h-screen flex flex-col bg-[#0d0c0e]'>
      ...
      {/* Mobile Layout - Show token data, chart, and mobile tabs */}
      <div className="lg:hidden flex flex-col pb-[150px] flex-1">
        {/* Token Data - Always visible on mobile */}
        <TokenData 
          marketData={marketData}
          selectedSymbol={selectedSymbol}
          availableTokens={availableTokens}
        ...
        {/* Trading Chart - Always visible on mobile */}
        ...
        {/* Mobile Tabs - Shows different content based on activeTab */}
        <MobileTabs />
      </div>
    </div>
  );
